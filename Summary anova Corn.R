...
NUE_stats_21 <- summarySE(Corn_data_2021, measurevar="NUE", groupvars=c("Irrigation"))
NUE_stats_21 <-NUE_stats_21[,c(1,3)]
NUE_stats_21$.group <- NA
...
#write.csv(Irrigation_summary, "Irrigation_summary.csv")

##############################################################################################################################
# Interaction Effect


Yield_stats_20 <- summarySE(Corn_data_2020, measurevar="Yield", groupvars=c("Nrate","Irrigation"))
Yield_stats_20 <-Yield_stats_20[,c(1,2,4)]
Yield_stats_20$.group <- NA

Yield_stats_21 <- summarySE(Corn_data_2021, measurevar="Yield", groupvars=c("Nrate","Irrigation"))
Yield_stats_21 <-Yield_stats_21[,c(1,2,4)]
Yield_stats_21$.group <- NA

NUE_stats_20 <- summarySE(Corn_data_2020, measurevar="NUE", groupvars=c("Nrate","Irrigation"))
NUE_stats_20 <-left_join(NUE_stats_20[,c(1,2,4)],NUE_20_sign[,c(1,2,8)], by = c("Nrate"= "Nrate","Irrigation"= "Irrigation"))



NUE_stats_21 <- summarySE(Corn_data_2021, measurevar="NUE", groupvars=c("Nrate","Irrigation"))
NUE_stats_21 <-NUE_stats_21[,c(1,2,4)]
NUE_stats_21$.group <- NA


irrWUE_stats_20 <- summarySE(Corn_data_2020, measurevar="irrWUE", groupvars=c("Nrate","Irrigation"))
irrWUE_stats_20 <-irrWUE_stats_20[,c(1,2,4)]
irrWUE_stats_20$.group <- NA

irrWUE_stats_21 <- summarySE(Corn_data_2021, measurevar="irrWUE", groupvars=c("Nrate","Irrigation"))
...
#write.csv(Interaction_summary, "Interaction_summary.csv")
